...
class Game:
    ...
    def __repr__(self):
        return f"(id: {self.id}, slug: {self.slug}, name: {self.name}, metacritic: {self.metacritic}, released: {self.released}, rating: {self.rating}, playtime: {self.playtime}, background_image: {self.background_image}, genres: {self.genres})"
    
    def __init__(self,id, slug, name, metacritic, released, rating, playtime, background_image, genres):
        ...
        self.genres = Game.getGenreList(genres, id) #an array of address objects